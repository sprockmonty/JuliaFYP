...
problem.states.xfl=[r1f,v1f,-inf,r2f,v2f,-inf]; 
problem.states.xfu=[r1f,v1f,-inf,r2f,v2f,-inf];
...
problem.constraints.gl=[-inf,-inf,-inf,-inf,-inf,-inf,-inf,problem.mp.data.auxdata.tmin^2]; % Lower ounds for inequality constraint function gl =< g(x,u,p,t) =< gu
problem.constraints.gu=[0,0,0,0,0,0,0,problem.mp.data.auxdata.tmax^2]; % Upper ounds for inequality constraint function gl =< g(x,u,p,t) =< gu
